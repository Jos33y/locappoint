...
import {
    AffixInput, Button, Field, ImagePicker, Input, PhoneFrame, QrCode, Ring, Select, Sheet, Status, Stepper, Switch, Textarea,
...
const SLUG_STATUS = {
    ...
    taken: { tone: 'danger', word: 'Taken', text: 'Try adding your area, like femtos-baixa' },
                            ...
                            <div className="lc-setup__fields">
                                ...
                                <div className="lc-setup__pair">
                                    <Field label="Type of business" error={problems.category}>
                                        <Select value={details.category} onChange={(e) => setDetail({ category: e.target.value })}>
                                            <option value="">Choose one</option>
                                            {CATEGORIES.map((c) => <option key={c.value} value={c.value}>{c.value}</option>)}
                                        </Select>
                                    </Field>
                                    <Field label="City" error={details.cityChoice !== OTHER_CITY ? problems.city : undefined}>
                                        <Select value={details.cityChoice} onChange={(e) => setDetail({ cityChoice: e.target.value })}>
                                            {CITIES.map((c) => <option key={c.value} value={c.value}>{c.value}</option>)}
                                            <option value={OTHER_CITY}>Somewhere else</option>
                                        </Select>
                                    </Field>
                                </div>

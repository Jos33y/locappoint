...
Write-Host ""
Write-Host "  Locappoint - Cleanup after the live screen patch" -ForegroundColor Cyan
Write-Host ""
...
$targets = @(
    'src\pages\business\Setup.jsx.backup-live',
    'src\styles\business\setup.css.backup-live',
    'src\components\business\ShareLink.jsx.backup-live',
    'src\pages\business\Channels.jsx.backup-live',
    'live-screen.zip'
)
